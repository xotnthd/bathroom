...
function fn_tableAdd1(){
	...
	html1 += "<td>한글</td>";
	html1 += "	<td><input type='text' value=''/></td>";
	html1 += "	<td><input type='text' value=''/></td>";
	html1 += "</tr>";
	html1 += "<tr>";
	html1 += "	<td>영어</td>";
...
<div>
	...
	<div id="inputVal1">
		...
		<div>
			...
			한글명 : <input type="text" name="p_comp_nm" id="p_comp_nm" value=""/></br>
			영문명 : <input type="text" name="p_comp_nm_eng" id="p_comp_nm_eng" value=""/></br>
			중문명 : <input type="text" name="p_comp_nm_chn" id="p_comp_nm_chn" value=""/>
			
		</div>
		<div>
			1-2 연락처</br>
			* 이메일(필수) <input type="text" name="p_emailing" id="p_emailing" value=""/></br>
			* 전화번호(필수) <input type="text" name="p_phone_no" id="p_phone_no" value=""/></br>
			  FAX  <input type="text" name="p_fax_no" id="p_fax_no" value=""/>
		</div>
		<div>
			1-3 주소</br>
			* 한글주소(필수) 	<input type="text" name="p_addr_ko" id="p_addr_ko" value=""/><input type="text" name="p_addr_ko2" id="p_addr_ko2" value=""/></br>
			* 영문주소(필수) 	<input type="text" name="p_addr_eng" id="p_addr_eng" value=""/><input type="text" name="p_addr_eng2" id="p_addr_eng2" value=""/></br>
