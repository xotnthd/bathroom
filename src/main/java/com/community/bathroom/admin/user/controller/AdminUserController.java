...
public class AdminUserController {
    ...
    @TenantGuard(action = TenantGuard.Action.READ, menuUrl = "/admin/user")
    @GetMapping("/search")
    ...
    @TenantGuard(action = TenantGuard.Action.WRITE, menuUrl = "/admin/user")
    @PostMapping("/save")
    ...
    @TenantGuard(action = TenantGuard.Action.DELETE, menuUrl = "/admin/user")
