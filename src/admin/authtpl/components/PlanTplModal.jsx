...
const PlanTplModal = ({ isOpen, onClose, mode, formData, setFormData, handleSave }) => {
        ...
        <Modal
            ...
            footer={
                <>
                    ...
                    <button type="submit" form="planTplForm" className="admin-btn admin-btn-primary">
                        {mode === 'INSERT' ? '등록' : '수정'}
                    </button>
                </>
            }
