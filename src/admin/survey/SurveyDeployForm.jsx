    ...
    return (
        <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <h2 style={{ margin: 0 }}>{survId ? '배포 등�문 등�정' : '삭제배포 등�문 등�록'}</h2>
                <div>
                    {!survId && (
                        <button onClick={() => setShowTemplateModal(true)} style={{ padding: '8px 16px', background: '#e67e22', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer', marginRight: '10px' }}>등�플�추가등�오�등</button>
                    )}
            ...
            <div style={{ background: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #ddd', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: '15px', alignItems: 'center' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', gap: '15px' }}>
                        <CommonCodePicker grpCd="SYS_SE_CD" type="radio" name="sysSeCd" value={form.sysSeCd} onChange={(e) => setForm({...form, sysSeCd: e.target.value})} />
                    </div>
